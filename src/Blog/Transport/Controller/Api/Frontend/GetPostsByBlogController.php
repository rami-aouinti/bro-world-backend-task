...
#[AsController]
#[OA\Tag(name: 'Blog')]
readonly class GetPostsByBlogController
{
     ...
     * @return JsonResponse
     */
    #[Route(path: '/v1/platform/posts/{blog}/blog', name: 'posts_index_by_blogs', defaults: ['page' => '1'], methods: [Request::METHOD_GET])]
    #[Cache(smaxage: 10)]
    #[OA\Response(
        response: 200,
    ...
    ): JsonResponse
    {
        ...
        $cacheKey = 'application_posts_page_' . $blog->getId() . '_'. $page . ($tag ? '_tag_' . $tag->getName() : '');
